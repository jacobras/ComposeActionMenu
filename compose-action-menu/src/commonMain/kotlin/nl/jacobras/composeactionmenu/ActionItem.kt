 ...
 * @param iconVector Optional icon.
 * @param iconPainter Optional icon.
...
) : ActionItem(key, title, iconVector, iconPainter, showAsAction, enabled)
...
class CheckableActionItem(
    ...
    val onClick: (key: String) -> Unit
) : ActionItem(key, title, iconVector, iconPainter, ShowAsActionMode.NEVER, enabled)
